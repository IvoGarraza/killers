...
const Service = () => {
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center px-4 text-black relative ">
      ...
      <CornerDos clases="sm:h-18 w-32 h-1/6 fill-terciario absolute z-40 scale-x-[-1] -rotate-180 sm:left-1/5 left-[58%] sm:-top-16 -top-22"></CornerDos>
      <div className="absolute sm:w-1/5 w-[55%] sm:h-18 h-24 bg-terciario sm:-top-16 pl-24 pt-4 -top-16 rounded-tl-4xl left-4 z-30">
      ...
      <div className="w-full flex sm:flex-row flex-col text-center items-center sm:justify-around justify-center h-1/2 bg-terciario rounded-tr-xl">
        <span className="text-4xl font-normal">
          Estos son algunos
          <br /> de los servicios que <span className="text-cuarto">ofrecemos</span>
        </span>
        <div className="group bg-white rounded-full p-4 flex items-center justify-center">
