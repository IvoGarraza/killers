...
const Hero = () => {
  ...
  return (
    <div className="sm:pt-24 sm:px-8 px-4 w-full h-screen">
      ...
      <div className="rounded-2xl overflow-hidden h-2/3 relative">
        ...
        <Corner clases="w-18 h-18 fill-primario absolute z-40 left-0 bottom-1/6 -rotate-90"></Corner>
        <div className="absolute h-1/6 sm:w-1/5 w-3/5 z-40 bottom-0 left-0 p-1 bg-primario flex flex-row items-center justify-center">
